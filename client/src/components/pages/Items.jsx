  ...
  return (
    <div className="rounded-xl overflow-hidden shadow-lg">
      <div className="relative flexCenter group overflow-hidden transition-all duration-100">
        <Link
          to={`product/${id}`}
          className="h-12 w-12 bg-white rounded-full flexCenter absolute top-1/2 bottom-1/2 !py-2 z-20 scale-0 group-hover:scale-100 transition-all duration-1000"
        >
          <FaSearch className="scale-125 hover:rotate-90 hover:scale-125 translate-all duration-200" />
        </Link>
      ...
      <div className="p-4 overflow-hidden  ">
        <h4 className="my-[6px] medium-16 line-camp-2 text-gray-30">{name}</h4>
